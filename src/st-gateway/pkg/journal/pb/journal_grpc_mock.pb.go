// Code generated by protoc-gen-go-grpc-mock. DO NOT Update.
...
// UpdateJournal mocks base method.
func (m *MockJournalServiceClient) UpdateJournal(ctx context.Context, in *UpdateJournalRequest, opts ...grpc.CallOption) (*UpdateJournalResponse, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{ctx, in}
	for _, a := range opts {
		varargs = append(varargs, a)
	}
	ret := m.ctrl.Call(m, "UpdateJournal", varargs...)
	ret0, _ := ret[0].(*UpdateJournalResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// UpdateJournal indicates an expected call of UpdateJournal.
func (mr *MockJournalServiceClientMockRecorder) UpdateJournal(ctx, in interface{}, opts ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]interface{}{ctx, in}, opts...)
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateJournal", reflect.TypeOf((*MockJournalServiceClient)(nil).UpdateJournal), varargs...)
}

// UpdateTrade mocks base method.
func (m *MockJournalServiceClient) UpdateTrade(ctx context.Context, in *UpdateJournalRequest, opts ...grpc.CallOption) (*UpdateTradeResponse, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{ctx, in}
	for _, a := range opts {
		varargs = append(varargs, a)
	}
	ret := m.ctrl.Call(m, "UpdateTrade", varargs...)
	ret0, _ := ret[0].(*UpdateTradeResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// UpdateTrade indicates an expected call of UpdateTrade.
func (mr *MockJournalServiceClientMockRecorder) UpdateTrade(ctx, in interface{}, opts ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]interface{}{ctx, in}, opts...)
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateTrade", reflect.TypeOf((*MockJournalServiceClient)(nil).UpdateTrade), varargs...)
}
...
// UpdateJournal mocks base method.
func (m *MockJournalServiceServer) UpdateJournal(ctx context.Context, in *UpdateJournalRequest) (*UpdateJournalResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UpdateJournal", ctx, in)
	ret0, _ := ret[0].(*UpdateJournalResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
// UpdateJournal indicates an expected call of UpdateJournal.
func (mr *MockJournalServiceServerMockRecorder) UpdateJournal(ctx, in interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateJournal", reflect.TypeOf((*MockJournalServiceServer)(nil).UpdateJournal), ctx, in)
}

// UpdateTrade mocks base method.
func (m *MockJournalServiceServer) UpdateTrade(ctx context.Context, in *UpdateJournalRequest) (*UpdateTradeResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UpdateTrade", ctx, in)
	ret0, _ := ret[0].(*UpdateTradeResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
// UpdateTrade indicates an expected call of UpdateTrade.
func (mr *MockJournalServiceServerMockRecorder) UpdateTrade(ctx, in interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateTrade", reflect.TypeOf((*MockJournalServiceServer)(nil).UpdateTrade), ctx, in)
}
